...
const CreditCard = (props: CreditCardProps) => {
  ...
  return <div className={["faces", flipped && 'flipped'].join(' ')}  id="credit-card">
     <svg
        className="front"
        ...
        <g transform="translate(-4292.083 3513.639)">
            ...
            <tspan
                ...
                style={{fontFamily: "Teko"}}
                className="number-1"
            >{number && number.substring(0, 4)}</tspan>
            </text>
            <text
            ...
            <tspan
                ...
                style={{fontFamily: "Teko"}}
                className="number-2"
            >{number && number.substring(4, 8)}</tspan>
            </text>
            <text
            ...
            <tspan
                ...
                style={{fontFamily: "Teko"}}
                className="number-3"
            >{number && number.substring(8, 12)}</tspan>
            </text>
            <text
            ...
            <tspan
                ...
                style={{fontFamily: "Teko"}}
                className="number-4"
            >{number && number.substring(12, 16)}</tspan>
            </text>
        </g>
        </svg>
        <svg
