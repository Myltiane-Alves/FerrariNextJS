      ...
      {/* <form action="schedules-address.html">
        ...
        <div className="form-creditcard">
          <div className="form-fields">
            ...
            <div className="field">
              <input name="name" id="name" className="name" />
          ...
          <div className="form-card">
            <div className="faces" id="credit-card">
              <svg
                className="front"
              ...
              >
                <defs>
                  <style>
                    ...
                    font-weight: 400;
                    src: local('Teko'),
                    url('assets/fonts/Teko-Regular.ttf')
                    format('truetype');
                      }
                  </style>
                </defs>
              ...
              >
                <defs>
                  <style>
                    ...
                    url('../fonts/NothingYouCouldDo-Regular.ttf')
                    format('truetype');
                      }
                    @font-face {
                      font - family: 'Teko';
                ...
                <g transform="translate(-4292.083 3734.497)">
                  ...
                  <text
                    ...
                    fill="#333"
                    font-size="22"
                    font-family="NothingYouCouldDo, Nothing You Could Do"
                  >
                    <tspan
                      x="89.566"
                      y="21"
                      style="font-family: 'Nothing'"
                      className="name"
                    ></tspan>
                  </text>
                </g>
